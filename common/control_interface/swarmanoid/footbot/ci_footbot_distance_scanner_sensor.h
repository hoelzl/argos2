...
namespace argos {
   ...
   public:
      ...
      struct SReading {
         ...
         SReading() : Angle(0.0), Distance(0.0) {}

         SReading(const CRadians& c_angle, Real f_distance) :
            Angle(c_angle), Distance(f_distance) {
         }
      };
       ...
       *
       */
      virtual const TReadingsMap& GetReadingsMap(){
       ...
       *
       */
      virtual const TReadingsMap& GetShortReadingsMap(){
       ...
       *
       */
      virtual const TReadingsMap& GetLongReadingsMap(){
