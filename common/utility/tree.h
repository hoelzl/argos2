 ...
 * inside ARGoS.
 *
 * Description: a simple templated tree class conforming with the STL
 * Source: http://www.aei.mpg.de/~peekas/tree/
 * Date: 2007-04-27, updated 2008-09-29
 * Copied from: Carlo Pinciroli
