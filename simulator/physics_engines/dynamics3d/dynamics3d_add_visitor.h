...
/**
 * @file <argos2/simulator/physics_engines/dynamics3d/dynamics3d_add_visitor.h>
 *
 * @author Carlo Pinciroli - <cpinciro@ulb.ac.be>
 */

#ifndef DYNAMICS3D_ADD_VISITOR_H
#define DYNAMICS3D_ADD_VISITOR_H
...
namespace argos {
   ...
   public:
      ...
      CDynamics3DAddVisitor(CDynamics3DEngine& c_engine) :
         m_cEngine(c_engine) {}
