 ...
 *
 * @brief This file provides the common interface definition of handbot LEDs actuator.
 *
 * This file provides the common interface definition of handbot LEDs actuator.
 * There are 12 LEDs on the hand-bot ring.
 *
...
#ifndef CCI_HANDBOT_LEDS_ACTUATOR_H
#define CCI_HANDBOT_LEDS_ACTUATOR_H

namespace argos {
    class CCI_HandBotLedsActuator;
}
...
namespace argos {
    ...
    class CCI_HandBotLedsActuator : public CCI_Actuator {
    ...
    public:
         ...
         *
         */
        virtual ~CCI_HandBotLedsActuator() {
        }
