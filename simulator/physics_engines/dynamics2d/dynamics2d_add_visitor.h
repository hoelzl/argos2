...
/**
 * @file <argos2/simulator/physics_engines/dynamics2d/dynamics2d_add_visitor.h>
 *
 * @author Carlo Pinciroli - <cpinciro@ulb.ac.be>
 */

#ifndef DYNAMICS2D_ADD_VISITOR_H
#define DYNAMICS2D_ADD_VISITOR_H
...
namespace argos {
   ...
   class CDynamics2DAddVisitor : public CEntityVisitor {

   public:

      CDynamics2DAddVisitor(CDynamics2DEngine& c_engine) :
         m_cEngine(c_engine) {}
      virtual ~CDynamics2DAddVisitor() {}
