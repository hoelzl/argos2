...
/* The map of user functions */
std::map<std::string, CQTOpenGLUserFunctions_Maker *, std::less<std::string> > mapQTOpenGLUserFunctionFactory;
...
namespace argos {
   ...
   void CQTOpenGLMainWindow::CreatePOVRayToolBar() {
      m_pcPOVRayToolBar = addToolBar(tr("POVRay"));
      m_pcPOVRayToolBar->setObjectName("POVRayToolBar");
      m_pcPOVRayToolBar->addAction(m_pcPOVRayPreviewAction);
      m_pcPOVRayToolBar->addAction(m_pcPOVRayXMLAction);
   }
