...
/**
 * @file <argos2/simulator/physics_engines/kinematics2d_eyebot.h>
 *
 * @author Carlo Pinciroli - <cpinciro@ulb.ac.be>
 */

#ifndef KINEMATICS2D_EYEBOT_H
#define KINEMATICS2D_EYEBOT_H

namespace argos {
   class CKinematics2DEngine;
   class CKinematics2DEyeBot;
}
...
namespace argos {
   ...
   class CKinematics2DEyeBot : public CKinematics2DEntity {

   public:
      
      CKinematics2DEyeBot(CKinematics2DEngine& c_engine,
                         CEyeBotEntity& c_eyebot);
      virtual ~CKinematics2DEyeBot() {}
